...
vcs -Mupdate test_bench.sv  -o salida -full64 -debug_all -sverilog -l log_test -ntb_opts uvm-1.2 +lint=TFIPC-L -cm line+tgl +UVM_VERBOSITY=UVM_HIGH +UVM_TIMEOUT = 20000;
